...
<div class="titleheader">
  <h1 style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: bold; color: #4F4F4F">DASHBOARD  </h1>
</div>
    ...
    <tbody>
      ...
      while ($row = mysqli_fetch_array($result)) 
      {
        ...
        echo "<tr>
                ...
                <td style ='background-color: ".$color.";'><input type='submit' name='submit$i' value='DESCRIPTION' style ='color:black;' ></td>
