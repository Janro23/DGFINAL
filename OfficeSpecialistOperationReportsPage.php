...
<div class="titleheader">
  <h1 style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 30px; font-weight: bold; color: #4F4F4F">OPERATION REPORT</h1>
</div>
 <br>     
...
<div class="sidenav">
  ...
  <a class="active" href="OfficeSpecialistOperationReportsPage.php" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; " ><img src="Assets/navicons/activeoperation.png" alt="Operation Report Icon"> Catalogs</a>
...
<table class="amazing">
  ...
  while ($row = mysqli_fetch_array($result))
  {
    ...
    <tr>
      ...
      <td><input type='submit' name='details$i' value='DESCRIPTION'></td>
